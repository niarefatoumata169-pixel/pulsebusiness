...
@Component({
  selector: 'app-nouveau-reglement',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  template: `
    <div class="nouveau-reglement-container">
      <div class="header">
        <h1>Nouveau règlement international</h1>
        <button class="btn-cancel" routerLink="/international/reglements">Annuler</button>
      </div>
      ...
      <form class="form-card">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="number" class="form-control" placeholder="655.957" step="0.001">
          </div>
          <div class="form-group">
        ...
        <div class="form-actions">
          <button type="submit" class="btn-save">Enregistrer le règlement</button>
          <button type="button" class="btn-cancel" routerLink="/international/reglements">Annuler</button>
        </div>
      </form>
    </div>
  `,
  styles: [`
    .nouveau-reglement-container { padding: 24px; max-width: 800px; margin: 0 auto; }

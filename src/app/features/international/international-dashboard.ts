...
@Component({
    ...
    <div class="dashboard-container">
      ...
      <div class="kpi-grid">
        ...
        <div class="kpi-card">
          ...
          <div class="kpi-content">
            <span class="kpi-value">0</span>
            <span class="kpi-label">Pays</span>
          </div>
        </div>
        <div class="kpi-card">
          <div class="kpi-icon">🚢</div>
      ...
      <div class="quick-actions">
        ...
        <div class="action-buttons">
          <a routerLink="/international/douanes/nouveau" class="action-btn">
            <span class="action-icon">📋</span> Nouvelle déclaration
          </a>
          <a routerLink="/international/transitaires/nouveau" class="action-btn">
            <span class="action-icon">🚛</span> Nouveau transitaire
          </a>
          <a routerLink="/international/reglements/nouveau" class="action-btn">
            <span class="action-icon">💶</span> Nouveau règlement
          </a>
        </div>
      </div>
  ...
  styles: [`
    ...
    .operations-section { background: white; border-radius: 12px; padding: 20px; border: 1px solid #FCE7F3; }
    .empty-state { text-align: center; padding: 40px; background: #F9FAFB; border-radius: 8px; color: #9CA3AF; border: 2px dashed #FCE7F3; }
  `]
})
export class InternationalDashboard {
  today = new Date();
}

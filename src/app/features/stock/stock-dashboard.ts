...
@Component({
    ...
    <div class="dashboard-container">
      ...
      <div class="quick-actions">
        ...
        <div class="action-buttons">
          <a routerLink="/stock/articles/nouveau" class="action-btn">
            <span class="action-icon">📦</span> Nouvel article
          </a>
          <a routerLink="/stock/mouvements/nouveau" class="action-btn">
            <span class="action-icon">🔄</span> Nouveau mouvement
          </a>
          <a routerLink="/stock/categories/nouveau" class="action-btn">
            <span class="action-icon">📂</span> Nouvelle catégorie
          </a>
          <a routerLink="/stock/fournisseurs/nouveau" class="action-btn">
            <span class="action-icon">🏭</span> Nouveau fournisseur
          </a>
        </div>
      </div>
  ...
  styles: [`
    ...
    .alerts-section { background: white; border-radius: 12px; padding: 20px; border: 1px solid #FCE7F3; }

              ...
              <div *ngIf="activeTab === 'info'" class="tab-content">
                <div class="form-row">
                  <div class="form-group">
                    <label>Code *</label>
                    <input type="text" [(ngModel)]="currentFournisseur.code" name="code" readonly class="readonly">
                  </div>
                  <div class="form-group">
                    <label>Nom *</label>
          ...
          <div class="fournisseur-card" *ngFor="let f of filteredFournisseurs" [class]="f.statut">
            ...
            <div class="card-footer">
              ...
              <div class="footer-actions">
                <button class="action-icon" (click)="viewDetails(f)" title="Voir">👁️</button>
...
<div class="modal-overlay" *ngIf="showDeleteModal">
  <div class="modal-container small">
    ...
    <div class="modal-body">
      ...
      <div class="alert-warning" *ngIf="fournisseurToDelete && fournisseurToDelete.totalAchats && fournisseurToDelete.totalAchats > 0">
...
export class Fournisseurs implements OnInit {
  ...
  getNoteMoyenne(): number {
    ...
    return this.fournisseurs.reduce((sum, f) => sum + (f.note || 0), 0) / this.fournisseurs.length;
  }
  ...
  getPerformanceMoyenne(): number {
    if (this.fournisseurs.length === 0) return 0;
    return this.fournisseurs.reduce((sum, f) => sum + (f.performance || 0), 0) / this.fournisseurs.length;
  }
  ...
  filterFournisseurs() {
    ...
    const firstItem = this.filteredFournisseurs[0];

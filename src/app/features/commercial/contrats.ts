...
@Component({
  ...
  template: `
    <div class="contrats-container">
      <div class="header">
        <h1>Contrats</h1>
        <button class="btn-add" routerLink="/commercial/contrats/nouveau">
          + Nouveau contrat
        </button>
      </div>
      ...
      <div class="stats-grid">
        ...
        <div class="stat-card">
          <span class="stat-value">0</span>
          <span class="stat-label">À renouveler</span>
        </div>
        <div class="stat-card">
      ...
      <div class="empty-state">
        ...
        <button class="btn-primary" routerLink="/commercial/contrats/nouveau">
          + Nouveau contrat
        </button>
      </div>
    </div>
  `,
  styles: [`
    .contrats-container { padding: 24px; max-width: 1200px; margin: 0 auto; }

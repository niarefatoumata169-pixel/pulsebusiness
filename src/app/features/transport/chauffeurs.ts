...
@Component({
  ...
  template: `
    <div class="chauffeurs-container">
      <div class="header">
        ...
        <button class="btn-add" routerLink="/transport/chauffeurs/nouveau">
          + Nouveau chauffeur
        </button>
      </div>
      ...
      <div class="empty-state">
        ...
        <button class="btn-primary" routerLink="/transport/chauffeurs/nouveau">
  ...
  `,
  styles: [`
    .chauffeurs-container { padding: 24px; max-width: 1200px; margin: 0 auto; }

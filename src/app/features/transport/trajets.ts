...
@Component({
  ...
  template: `
    <div class="trajets-container">
      <div class="header">
        ...
        <button class="btn-add" routerLink="/transport/trajets/nouveau">
          + Nouveau trajet
        </button>
      </div>
      ...
      <div class="empty-state">
        ...
        <button class="btn-primary" routerLink="/transport/trajets/nouveau">
          + Ajouter un trajet
        </button>
      </div>
    </div>
  `,
  styles: [`
    .trajets-container { padding: 24px; max-width: 1200px; margin: 0 auto; }

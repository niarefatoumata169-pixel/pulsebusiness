...
@Component({
  ...
  template: `
    <div class="maintenance-container">
      <div class="header">
        ...
        <button class="btn-add" routerLink="/transport/maintenance/nouveau">
      ...
      <div class="empty-state">
        ...
        <h2>Aucune intervention trouvée</h2>
        <p>Commencez par planifier votre première maintenance</p>
        <button class="btn-primary" routerLink="/transport/maintenance/nouveau">
          + Nouvelle intervention
        </button>
      </div>
    </div>
  `,
  styles: [`
    .maintenance-container { padding: 24px; max-width: 1200px; margin: 0 auto; }

...
@Component({
  ...
  template: `
    <div class="nouveau-client-container">
      <div class="header">
        ...
        <form (ngSubmit)="saveClient()" #clientForm="ngForm">
          ...
          <div *ngIf="activeTab === 'contact'" class="tab-content">
            <div class="form-grid">
              ...
              <div class="form-group">
                <label>Pays *</label>
                <input type="text" [(ngModel)]="client.pays" name="pays" value="Mali" required>
              </div>
              <div class="form-group">
          ...
          <div *ngIf="activeTab === 'commercial'" class="tab-content">
            <div class="form-grid">
              ...
              <div class="form-group">
                ...
                <input type="number" [(ngModel)]="client.delai_paiement" name="delai_paiement" min="0" value="30">
              </div>
              <div class="form-group">
                <label>Devise</label>
                <input type="text" [(ngModel)]="client.devise" name="devise" value="FCFA">
              </div>
              <div class="form-group">
          ...
          <div class="form-actions">
            <button type="button" class="btn-cancel" routerLink="/clients">Annuler</button>
  ...
  `,
  styles: [`
    .nouveau-client-container { padding: 24px; max-width: 1200px; margin: 0 auto; }
...
export class NouveauClient {
  ...
  saveClient() {
    ...
    const newClient = {
      ...this.client,
      id: Date.now(),
      code: 'CLI-' + new Date().getFullYear() + '-' + String(clients.length + 1).padStart(3, '0'),
      encours: 0
    };

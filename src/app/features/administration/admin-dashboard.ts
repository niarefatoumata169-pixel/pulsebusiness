...
@Component({
    ...
    <div class="dashboard-container">
      ...
      <div class="quick-actions">
        ...
        <div class="action-buttons">
          <a routerLink="/administration/entites/nouveau" class="action-btn">
            <span class="action-icon">🏢</span> Nouvelle entité
          </a>
          <a routerLink="/administration/filiales/nouveau" class="action-btn">
            <span class="action-icon">🏭</span> Nouvelle filiale
          </a>
          <a routerLink="/administration/departements/nouveau" class="action-btn">
            <span class="action-icon">📂</span> Nouveau département
          </a>
          <a routerLink="/administration/postes/nouveau" class="action-btn">
            <span class="action-icon">👔</span> Nouveau poste
          </a>
        </div>
      </div>
  ...
  styles: [`
    ...
    .activities-section { background: white; border-radius: 12px; padding: 20px; border: 1px solid #FCE7F3; }

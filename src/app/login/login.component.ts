    ...
    <div class="login-container">
      <div class="login-card">
        ...
        <div class="register-section">
          <p>Première visite ? <a routerLink="/register">Créer un compte</a></p>
        </div>

        <!-- Accès démo - avec &#64; au lieu de @ -->
        <div class="demo-section">
          <p class="demo-title">🔐 Accès démonstration</p>
          <div class="demo-credentials">
            <div class="demo-row">
              <span>Email:</span>
              <strong>demo&#64;pulsebusiness.com</strong>
            </div>
            <div class="demo-row">
          ...
          <button class="btn-demo" (click)="fillDemo()" [disabled]="loading">
...
export class LoginComponent implements OnInit {
  ...
  fillDemo() {
    this.email = 'demo@pulsebusiness.com';
